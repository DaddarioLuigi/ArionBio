                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 style="color:#ad2e72;" class="card-title">Kyprion concime inorganico a base di microelementi(Rame)</h5>
                                <p class="card-text">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 style="color: #ad2e72;" class="card-title">Blindax-SB bioprotettore a base di lecitina di soia</h5>
                                <p class="card-text">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 style="color:#ad2e72;" class="card-title">Ecogreen SMC v60 concime organico azotato di origine naturale</h5>
                                <p class="card-text">
        ...
        <div class="container-fluid">
            <div class="row g-5 align-items-center">
                <div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <a style="background-color: #e9439a;border-color: #e9439a;" class="btn btn-primary py-3 px-4" href="#preventivo">Richiedi un preventivo </a>
                </div>
            </div>
        </div>
    </div>
